...
?>
<div class="container">
    <h3 class="text-center text-success my-3">Thêm khóa học</h3>
    <form method="POST" action="?c=course&a=store">
        <div class="mb-3">
            <label for="inputTitle" class="form-label">Tên khóa học</label>
